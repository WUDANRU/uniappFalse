	...
	<view>
		...
		<view class="position-relative" style="height:320rpx;">
			...
			<view class="d-flex a-center" style="min-width:750rpx;margin-top:-200rpx;">
				<image src="/static/images/demo/demo6.jpg" style="margin-left:20rpx;width:145rpx;height:145rpx;" 
				class="rounded-circle border-light ml-4"></image>
				
				<!-- <navigator url="../login/login"> -->
				<view class="ml text-white font-sm" @click="navigate('login')" style="z-index:1000;color:#007AFF">测试昵称</view>
				<!-- </navigator> -->
		...
		<card>
			<view slot="title" class="d-flex a-center j-sb">
				...
				<view class="text-secondary font-3" @click="navigate('order')">
			...
			<view class="d-flex a-center">
				...
				hover-class="bg-light-secondary"
				 v-for="i in 4" :key="i">  <!-- 这是card1子组件里body的slot -->
					<view class="iconfont icon-cpu font-sm line-h"></view>
					<view class="font-2" style="margin-top:20upx;">待付款</view>
				</view>
			</view>
		</card>
